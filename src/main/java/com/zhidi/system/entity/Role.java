...
public class Role implements java.io.Serializable {
    ...
    @ManyToMany()
    @JoinTable(name = "TB_SYSTEM_ROLE_FUNCTION", schema = "NICETEAM", joinColumns = {
    ...
    public static Role fromRoleVo(RoleVo roleVo, User user) throws ParseException {
        if (roleVo != null){
            Role role = new Role();
            role.setId(roleVo.getId());
            //role.setCreatetime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(roleVo.getCreatetime()));
            role.setUpdatetime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(roleVo.getUpdatetime()));
