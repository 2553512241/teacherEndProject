...
<body>
<div>
    <span>客户视图：</span><span onclick="return whole('manage/customer/findCustomerByPage.action')" class="easyui-linkbutton" data-options="iconCls:'icon-ok',plain:true">全部</span>|
    <span onclick="return myCustomer('manage/customer/myCustomer.action')" class="easyui-linkbutton" data-options="plain:true">我的客户</span>|
    ...
    <table>
        <tr>
            ...
            <td  class="text-content">
                <input name="search" id="search" type="text" placeholder="请输入查询关键字">
                <span id="search" onclick="doSearch()" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true">搜索</span>
            </td>
            <td>
            ...
            <td>
                <span onclick="return add('manage/customer/add.action')" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">新建客户</span>
...
<script type="text/javascript">
    $(function(){
        //分页展示客户列表
        $("#customerLs").datagrid({
            url:"manage/customer/findCustomerByPage.action",
            checkOnSelect:false,
            idField:"customerId",
            pagination:true,
            sortName:"customerId",
            columns:[[
                ...
                {field:"follow",title:"关注",
                    formatter:function(value,row,index){
                        ...
                        $.ajax({
                            type: "post",
                            url: "manage/customer/isFollowed.action",
                ...
                {field:"operation",title:"操作",formatter:function(value,rowData,index){
                    return "<a href='javascript:void(0);' onclick=\"return see(\'manage/customer/showSee.action\',\'"+rowData.id+"\')\">查看</a>"+
                        " <a href='javascript:void(0);' onclick=\"return modify(\'manage/customer/showEdit.action\',\'"+rowData.id+"\')\">编辑</a>"
                }}
