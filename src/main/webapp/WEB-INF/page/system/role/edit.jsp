		...
		<form id="form" method="post">
			<table>
				...
				<tr>
					...
					<td class="text-content" >
						<input type="text" name="roleVo.updatetime" value="<%=new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())%>"
							   class="easyui-textbox theme-textbox-radius" data-options="required:true,validType:'length[3,10]'">
					</td>
				</tr>
				...
				<tr style="display: none;">
					<td colspan="2">
						<input type="hidden" name="roleVo.functionIds" value="${roleVo.functionIds}">
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#saveBtn").on("click",function(event){
                $.post("system/role/updateRole.action",$("#form").serialize(),function(result){
                    if(result.success){
