...
<html>
  ...
  <body >
    ...
    <div id="toolbar">
    	<a href="javascript:void(0);" onclick="return add('system/user/edit.action')" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">新建</a>
    ...
    <script type="text/javascript">
    	...
    	$(function(){
    		$("#userList").datagrid({
    			url : "system/user/findUserByPager.action",
    			pagination : true,
    			toolbar : "#toolbar",
    			fitColumns : true,
    			idField : "id",
